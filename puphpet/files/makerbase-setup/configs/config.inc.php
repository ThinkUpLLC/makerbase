...
$ISOSCELES_CFG['app_title']                 = 'Makerbase';
...
$ISOSCELES_CFG['db_user']                   = 'makerbase';
$ISOSCELES_CFG['db_password']               = 'nice2bnice';
$ISOSCELES_CFG['db_name']                   = 'makerbase_web';
$ISOSCELES_CFG['db_socket']                 = '';
$ISOSCELES_CFG['db_port']                   = '';
$ISOSCELES_CFG['table_prefix']              = '';
...
$ISOSCELES_CFG['enable_profiler']           = true;
...
|| (getenv("MODE")=="TESTS" && ! getenv("RD_MODE")=="1")) {
    ...
    $ISOSCELES_CFG['db_name']                   = 'makerbase_tests'; //by default, isosceles_tests
