TRUNCATE makers; TRUNCATE roles; TRUNCATE products;
...
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Programmer, front and back end', '2011-12-01', '2012-05-01');
...
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Co-founder', '2005-01-01', '2009-05-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'busterbenson';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Creator', '2009-08-01', NULL);
...
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'I suggested that the app icon be tweaked to include a checkmark.', '2004-02-01', '2004-02-01');
...
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Developer', '1999-08-01', '2001-01-01');
SELECT id INTO @maker_id FROM makers WHERE slug = 'matt-haughey';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Designer', '2000-04-01', '2001-01-01');
SELECT id INTO @maker_id FROM makers WHERE slug = 'evan-williams';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Co-founder', '1999-08-01', '2005-10-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'busterbenson';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Founder', '2012-01-01', NULL);
...
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Co-founded it and was deeply engaged with the community.', '2003-03-01', '2007-04-01');
SELECT id INTO @maker_id FROM makers WHERE slug = 'adammathes';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Guy 2', '2003-04-01', '2005-11-01');
...
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Contract iPhone programmer', '2011-03-01', '2011-04-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'matt-haughey';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Designer', '2002-02-01', '2005-10-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'benbrown';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Inventor', '1998-11-01', '2000-08-01');
SELECT id INTO @maker_id FROM makers WHERE slug = 'adammathes';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Engineer', '2000-05-01', '2000-08-01');
...
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Creator', '2003-11-01', '2007-06-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'torrez';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Creator', '2002-05-01', '2007-05-01');
...
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Virtual Research Fellow', '2009-05-01', NULL);
SELECT id INTO @maker_id FROM makers WHERE slug = 'jamiew';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Virtual Research Fellow', '2007-09-01', NULL);


INSERT INTO products (slug, name, description, url, avatar_url) VALUES ('filepile', 'FilePile', 'A place for', 'http://filepile.org/', '');
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'torrez';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Creator', '2000-06-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'matt-haughey';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Co-founder', '2008-08-01', NULL);
SELECT id INTO @maker_id FROM makers WHERE slug = 'paul-bausch';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Co-founder', '2008-08-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'torrez';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Creator', '2012-04-01', NULL);
...
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Responsible for the entire web presence, including an amazing Index.', '2005-02-01', '2010-04-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'busterbenson';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Founder', '2010-05-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'markpasc';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Creator & programmer', '2005-05-01', '2006-05-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'anildash';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'I created the site and promoted the hashtag, which still gets used regularly a few years later', '2009-04-01', NULL);
SELECT id INTO @maker_id FROM makers WHERE slug = 'mike-monteiro';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Designer', '2009-04-01', '2009-06-01');
SELECT id INTO @maker_id FROM makers WHERE slug = 'ginatrapani';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Contributed a testimonial to the site', '2009-04-01', '2009-04-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'torrez';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Creator', '2011-09-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'markpasc';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Programmer', '2010-04-01', NULL);
SELECT id INTO @maker_id FROM makers WHERE slug = 'apparentlymart';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Occasional Programmer', '2010-04-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'ginatrapani';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Founding Editor', '2005-01-01', '2009-01-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'apparentlymart';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Programmer', '1999-01-01', '2007-01-01');
SELECT id INTO @maker_id FROM makers WHERE slug = 'bradfitz';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Creator, Proprietor, Programmer', '1997-01-01', '2005-02-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'busterbenson';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Creator', '2009-08-01', '2011-01-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'markpasc';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Programmer', '2010-01-01', '2010-08-01');
SELECT id INTO @maker_id FROM makers WHERE slug = 'apparentlymart';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Cheerleader, Occasional Programmer', '2010-01-01', '2010-08-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'benbrown';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Designer', '2011-03-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'markpasc';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Programmer', '2012-02-01', NULL);
SELECT id INTO @maker_id FROM makers WHERE slug = 'anildash';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Came up with the idea', '2011-11-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'gleuch';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Founder & Creator', '2011-05-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'matt-haughey';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Founder', '1999-07-01', NULL);
SELECT id INTO @maker_id FROM makers WHERE slug = 'paul-bausch';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'CTO', '2006-05-01', NULL);
...
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'made part of ', '2011-02-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'torrez';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Creator and programmer', '2011-01-01', NULL);
SELECT id INTO @maker_id FROM makers WHERE slug = 'amber';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Creator and designer', '2010-12-01', NULL);
SELECT id INTO @maker_id FROM makers WHERE slug = 'markpasc';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Contract API programmer & test writer', '2011-05-01', '2011-06-01');
SELECT id INTO @maker_id FROM makers WHERE slug = 'anildash';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'I gave a little bit of advice, some of it was even solicited.', '2010-12-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'markpasc';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Occasional programmer', '2004-05-01', '2008-12-01');
SELECT id INTO @maker_id FROM makers WHERE slug = 'anildash';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'I managed the business division that made MT for a few years, and did lots of stuff with the community.', '2003-04-01', '2009-10-01');
SELECT id INTO @maker_id FROM makers WHERE slug = 'djacobs';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'I helped program widely-used plugins for MT, founded a company to help support  plugins and the core product, and managed the MT business.', '2004-04-01', '2010-10-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'markpasc';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Programmer', '2008-02-01', '2011-10-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'ginatrapani';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Creator', '2012-03-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'torrez';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Creator', '2002-02-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'benbrown';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Creator', '2012-02-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'anildash';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Helped brainstorm the original "Stack Overflow" name; Now I''m on the board.', '2008-07-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'benbrown';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Creator', '2011-04-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'anildash';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Co-founder, working on everything from running the business to hacking CSS.', '2009-06-01', NULL);
SELECT id INTO @maker_id FROM makers WHERE slug = 'ginatrapani';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Co-founder', '2009-06-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'ginatrapani';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Founder and lead developer', '2006-05-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'ginatrapani';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Host', '2009-08-01', NULL);
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'evan-williams';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Co-founder', '2006-07-01', '2011-03-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'markpasc';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Occasional programmer', '2004-05-01', '2010-11-01');
SELECT id INTO @maker_id FROM makers WHERE slug = 'anildash';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Helped launch the service, working on everything from marketing to pricing to helping major users.', '2003-05-01', '2009-10-01');
SELECT id INTO @maker_id FROM makers WHERE slug = 'apparentlymart';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Programmer, API Designer', '2008-10-01', '2010-11-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'benbrown';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Founder', '2000-05-01', '2005-12-01');
SELECT id INTO @maker_id FROM makers WHERE slug = 'adammathes';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Founder', '2000-05-01', '2005-12-01');
...
SELECT LAST_INSERT_ID() INTO @product_id;
SELECT id INTO @maker_id FROM makers WHERE slug = 'waxpancake';
INSERT INTO roles (product_id, maker_id, role, start, end) VALUES (@product_id, @maker_id, 'Founded, developed,  and managed the community. Also sold it to Yahoo.', '2003-09-01', '2007-11-01');
