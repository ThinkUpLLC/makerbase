...
<div class="row about-page">
	<div class="col-xs-12 col-sm-10 col-sm-offset-1">
		...
		<h2 class="style-bubblegum">Who is Makerbase for?</h2>
		...
		<h2 class="style-creamsicle">Who makes Makerbase?</h2>

		<img src="/assets/img/nyt-pic-square.jpg" alt="Gina Trapani and Anil Dash" class="col-xs-12 col-sm-4 img-responsive pull-right">

		<p><strong>We all do!</strong> It's user-edited, kind of like Wikipedia, which means that anyone can sign in with a Twitter account and add or revise the content on the site.</p>
		<p>The Makerbase site itself was built and is managed by Anil Dash and Gina Trapani. (Our company is called ThinkUp, after our first product. You can read more <a href="https://www.thinkup.com/join/about/">about ThinkUp</a> and <a href="https://www.thinkup.com/join/about/values.php">about our values</a>.)</p>
		...
		<h2 class="style-pea">I want to write about Makerbase.</h2>
