...
<div class="row">
   <div class="page-header col-sm-10 col-sm-offset-1 col-xs-12">
      ...
      {if $email_capture_state eq 'need_email'}
        ...
        <h3 class="">We're asking for your email, but don't worry.</h3>
...
<div class="row">
  <p class="btn btn-default btn-link pull-right">Want to close your account? Need help? <a href="mailto:team@makerba.se">Get in touch</a>.</p>
</div>
{else}
<div class="row">
