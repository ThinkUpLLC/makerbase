        ...
        <div id="project-info-profile">
          ...
          {if isset($logged_in_user)}
             {if !$product->is_archived}
              <div id="unfollow{$product->uid}" class="follow-button {if $logged_in_user->is_following_product eq false}hidden{/if}" ><a class="btn btn-xs btn-default btn-unfollow" uid="{$product->uid}" type="project" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Unfollowing" >Following</a></div>
              <div id="follow{$product->uid}" class="follow-button {if $logged_in_user->is_following_product eq true}hidden{/if}" ><a class="btn btn-xs btn-info btn-follow" uid="{$product->uid}" type="project" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Following">Follow</a></div>
             {/if}
          {else}
