	...
	<div class="col-sm-6 col-xs-12">
		...
		<form method="post" action="/add/{$object}/" class="form-horizontal">
			<div class="form-group">
				<label for="full_name" class="col-xs-2 control-label">Name</label>
				<div class="col-xs-10">
					<input type="text" class="form-control" name="name" id="name" value="{if isset($name)}{$name}{/if}">
				</div>
			</div>
			<div class="form-group">
				<label for="url" class="col-xs-2 control-label">Web site</label>
				<div class="col-xs-10">
			...
			{/if}
			<div class="form-group">
				<label for="description" class="col-xs-2 control-label">Slug</label>
				<div class="col-xs-10">
					<input type="text" class="form-control col-xs-6" name="slug" id="slug" value="{if isset($slug)}{$slug}{/if}">
				</div>
			</div>
			<div class="form-group">
				<label for="avatar_url" class="col-xs-2 control-label">Avatar URL</label>
				<div class="col-xs-2">
		...
		<!-- begin auto-fill loop here -->
			...
			<a class="list-group-item media add-autofill" data-name="{if isset($name)}{$name}{/if}" data-avatar="{if isset($avatar_url)}{$avatar_url}{/if}" data-url="{if isset($url)}{$url}{/if}" data-description="{if isset($description)}{$description}{/if}" data-slug="{if isset($slug)}{$slug}{/if}">
				<div class="media-left media-middle">
					{if isset($avatar_url)}<img src="{$avatar_url}" id="avatar-img" width="30" style="float: right;">{/if}
				</div>
			...
			<a class="list-group-item media add-autofill" data-name="{if isset($name)}{$name}{/if} 2" data-avatar="{if isset($avatar_url)}{$avatar_url}{/if}#2" data-url="{if isset($url)}{$url}{/if}#2" data-description="2 {if isset($description)}{$description}{/if}" data-slug="{if isset($slug)}{$slug}{/if}">
				<div class="media-left media-middle">
					{if isset($avatar_url)}<img src="{$avatar_url}" id="avatar-img" width="30" style="float: right;">{/if}
				</div>
			...
			<a class="list-group-item media add-autofill" data-name="{if isset($name)}{$name}{/if} 3" data-avatar="{if isset($avatar_url)}{$avatar_url}{/if}#3" data-url="{if isset($url)}{$url}{/if}#3" data-description="3 {if isset($description)}{$description}{/if}" data-slug="{if isset($slug)}{$slug}{/if}">
				<div class="media-left media-middle">
					{if isset($avatar_url)}<img src="{$avatar_url}" id="avatar-img" width="30" style="float: right;">{/if}
				</div>
