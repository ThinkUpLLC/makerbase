...
<div class="list-group-item col-xs-10">
    ...
    <div class="media-body">
        <a {if isset($logged_in_user)}href="#edit-role-{$role->uid}" data-toggle="collapse" onclick="$('#role-description-{$role->uid}').toggle();$('#role-archive-{$role->uid}').toggle();"{else}href="{$sign_in_with_twttr_link}"{/if} type="button" class="btn btn-text btn-xs pull-right" id="edit-role-btn">edit</a>
...
<form method="post" action="/edit/role/" class="col-xs-2 role-archive-form" id="role-archive-{$role->uid}">
